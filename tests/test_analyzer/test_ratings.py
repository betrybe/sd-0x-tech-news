...
LIST_FIVE_NOTICES = [('noticia_1', 'https://www.tecmundo.com.br/noticia_1.htm'), ('noticia_2', 'https://www.tecmundo.com.br/noticia_2.htm'), ('noticia_3', 'https://www.tecmundo.com.br/noticia_3.htm'), ('noticia_4', 'https://www.tecmundo.com.br/noticia_4.htm'), ('noticia_5', 'https://www.tecmundo.com.br/noticia_5.htm')]
LIST_FIVE_CATEGORY = ['Console_1', 'Console_2', 'Console_3', 'Console_4', 'Console_5']

def test_listar_as_top_cinco_noticias():
    db.news.delete_many({})
    db.news.insert_many([NEW_NOTICE_1,NEW_NOTICE_2,NEW_NOTICE_3,NEW_NOTICE_4,NEW_NOTICE_5,NEW_NOTICE_6])
